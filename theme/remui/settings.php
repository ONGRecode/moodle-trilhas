...
if ($ADMIN->fulltree) {
    ...
    if ($homepage || $edwpagebuilderavailable) {
        if ($homepage) {
            $options = array(
        ...
        if ($edwpagebuilderavailable && $homepage) {
            $options = array(
                0 => new lang_string('frontpagedesignold', 'theme_remui'),
                1 => new lang_string('pluginname', $homepage->get_component()),
                3 => new lang_string('homepageedwpagebuilderoption', 'theme_remui')
    ...
    } else if ($edwpagebuilderavailable && $activehomepage != 0 && is_plugin_available('local_remuihomepage')) {
        $page->add(new admin_setting_description(
            'newhomepagedescription',
            '',
            $depricationdescription
