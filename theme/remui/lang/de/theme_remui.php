...
$string['settingpage-dep-top-st3'] = '1. Aktualisieren Sie den Edwiser RemUI Page Builder auf die Version v4.1.3 oder höher (Ordnername: moodle/local/edwiserpagebuilder)';

$string['settingpagedepbottomst1'] = '2. Wählen Sie den Page Builder in der obigen Dropdown-Liste aus und gehen Sie zur Startseite, um ein neues Startseiten-Design zu erstellen.';
$string['settingpagedepbottomst2'] = 'Erfahren Sie mehr';
$string['settingpagedepbottomst3'] = 'ODER';

$string['settingpagedepbottomsecondaryst1'] = '2. Migrieren Sie automatisch Ihre aktuelle Startseite zum Edwiser Page Builder.';
$string['settingpagedepbottomsecondaryst2'] = '<small class="d-block p-mt-2d5" style="color: #DC3545;"><span class="para-semibold-1 m-0">Hinweis:</span> Es wird die Edwiser RemUI Page Builder Plugin-Version v4.1.3 und die Homepagebuilder Plugin-Version v4.1.3 benötigt. Bitte aktualisieren Sie die Plugins auf die neueste Version.</small>';
...
$string['settingpagedepbottomsecondaryst5'] = '<span class="para-semibold-1 m-0">Hinweis:</span> Nach den nächsten drei Updates wird der aktuelle Homepage Builder von Edwiser RemUI veraltet sein.';
