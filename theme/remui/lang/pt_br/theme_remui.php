...
$string['settingpage-dep-top-st3'] = '1. Atualize o Edwiser RemUI Page Builder para a versão v4.1.3 ou superior (Nome da pasta: moodle/local/edwiserpagebuilder)';

$string['settingpagedepbottomst1'] = '2. Selecione o Construtor de Página na lista suspensa acima e vá para a Página Inicial para criar um novo design de página inicial.';
$string['settingpagedepbottomst2'] = 'Saiba Mais';
$string['settingpagedepbottomst3'] = 'OU';

$string['settingpagedepbottomsecondaryst1'] = '2. Migrar automaticamente sua página inicial atual para o Edwiser Page Builder.';
$string['settingpagedepbottomsecondaryst2'] = '<small class="d-block p-mt-2d5" style="color: #DC3545;"><span class="para-semibold-1 m-0">Observação:</span> É necessário o Edwiser RemUI Page Builder Plugin versão v4.1.3 e o Plugin Homepagebuilder versão v4.1.3, por favor, atualize os plugins para a versão mais recente.</small>';
...
$string['settingpagedepbottomsecondaryst5'] = '<span class="para-semibold-1 m-0">Observação:</span> Após as próximas três atualizações, o construtor de página inicial atual será descontinuado no Edwiser RemUI';
