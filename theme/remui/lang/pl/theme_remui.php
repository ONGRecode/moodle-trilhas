...
$string['settingpage-dep-top-st3'] = "1. Zaktualizuj Edwiser RemUI Page Builder do wersji v4.1.3 lub nowszej (Nazwa folderu: moodle/local/edwiserpagebuilder).";

$string['settingpagedepbottomst1'] = "2. Wybierz Kreator stron w rozwijanym menu powyżej i przejdź do strony głównej, aby stworzyć nowy układ strony głównej.";
$string['settingpagedepbottomst2'] = "Dowiedz się więcej";
$string['settingpagedepbottomst3'] = "LUB";

$string['settingpagedepbottomsecondaryst1'] = "2. Automatycznie przenieś swoją obecną stronę główną do Edwiser Page Builder.";
$string['settingpagedepbottomsecondaryst2'] = '<small class="d-block p-mt-2d5" style="color: #DC3545;"><span class="para-semibold-1 m-0">Uwaga:</span> Wymagane są wersja wtyczki Edwiser RemUI Page Builder v4.1.3 i wersja wtyczki Homepagebuilder v4.1.3. Prosimy zaktualizować wtyczki do najnowszej wersji.</small>';
...
$string['settingpagedepbottomsecondaryst5'] = '<span class="para-semibold-1 m-0">Uwaga:</span> Po kolejnych trzech aktualizacjach bieżący Kreator strony głównej zostanie wycofany z Edwiser RemUI.';
