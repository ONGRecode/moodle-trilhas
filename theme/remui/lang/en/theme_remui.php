...
$string['settingpage-dep-top-above-st'] = 'Click on \'Site Home\' from the Navigation bar to go to \'Homepage Builder\' and create your own Homepage';
...
$string['settingpage-dep-top-st3'] = '1.Update the Edwiser RemUI Page Builder to version  v4.1.3 and above (Folder name : moodle/local/edwiserpagebuilder)';

$string['settingpagedepbottomst1'] = '2.Select the Page Builder in the drop down above, and go to the Homepage to create a new homepage design.';
$string['settingpagedepbottomst2'] = 'Learn More';
$string['settingpagedepbottomst3'] = 'OR';

$string['settingpagedepbottomsecondaryst1'] = '2.Automatically migrate your current homepage to the Edwiser Page Builder.';
$string['settingpagedepbottomsecondaryst2'] = '<small class="d-block p-mt-2d5" style="color: #DC3545;"><span class="para-semibold-1 m-0">Note:</span> Edwiser RemUI Page Builder Plugin version v4.1.3 Plugin and Homepagebuilder Plugin version v4.1.3  is required,  Please update the plugins to its latest version.</small>';
...
$string['settingpagedepbottomsecondaryst5'] = '<span class="para-semibold-1 m-0">Note:</span> After the next three updates, the current Homepage builder will be deprecated from the Edwiser RemUI ';
